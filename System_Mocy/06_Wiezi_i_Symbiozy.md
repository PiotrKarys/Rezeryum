...
- **Wielokrotność a Ryzyko:** Złożenie pierwszej Przysięgi to potężne przesterowanie, po którym nie ma gładkiego powrotu. Splot nie posiada sztywnego limitu na kolejne Przysięgi (stackowanie ewoluujących wyrzeczeń), jednakże każda następna to drastyczna eskalacja biologicznej degradacji na żywym ciele. To nie jest system bezpiecznego levelowania — to desperackie balansowanie na krawędzi samounicestwienia.
- **Rzadkość:** Vow nie jest masową praktyką. To narzędzie wyjątkowych jednostek podejmujących wyjątkowe decyzje. Jeśli każdy rzeźnik na rynku i każdy żebrak pod murem składałby Przysięgi — świat straciłby swój kręgosłup. Rzadkość i potworny koszt Vow to coś, co nadaje im ciężar.
...
## Odwiązanie i Blizna (Brak Powrotu Do Zera)

Normalnie, Splot dąży do utrzymania swojej formy. Vow jest brutalnym przesterowaniem, ale nie jest wyrokiem, którego nie da się cofnąć — jest po prostu **wyrokiem, po którym nie ma powrotu do czystej karty**.

Istnieje brutalna, niezwykle rzadko praktykowana procedura wymagająca najlepszych Alchemików i Chirurgów Splotu, pozwalająca na **Odwiązanie**. Przesterowanie zostaje cofnięte. Zamknięte kanały otwierają się. Zyskana specjalizacja rozpływa się.

Jednakże Splot nie działa jak sprężyna. Działa jak tkanka.
Odwiązanie nie resetuje rany — **zostawia Bliznę**. Organizm nigdy nie odzyskuje utraconej pierwotnie sprawności w 100%, a na strukturze percepcji i zdrowia pozostaje skaza (permanentne skrócenie ułamka długości życia i witalności — max HP). Składający wraca do punktu wyjścia, ale jako ktoś, kto już raz pękł. Nie ma w tym świecie darmowego „resetu umiejętności”. Każda ingerencja ma swoją cenę.

---

## Degradacja Biologiczna (Koszt Wielokrotnych Przysiąg)

Splot nie narzuca „twardego limitu” i nie krzyczy o błędzie systemu, jeśli Przebudzony spróbuje złożyć więcej niż jedną Przysięgę naraz (lub po Odwiązaniu). Wolno ci to zrobić.

Ale **zapłacisz ciałem**.

Każda kolejna inżynieria Vow na tym samym organizmie to drastyczna eskalacja biologicznej degradacji. Splot, nienaturalnie zszyty i zablokowany we wielu miejscach naraz, zaczyna konfliktować się z ciałem fizycznym. Rozpad następuje w czasie rzeczywistym.

- **Jedna aktywna Przysięga:** Równowaga. Biegłość. Weteran, z którym w walce trzeba się liczyć.
- **Dwie aktywne Przysięgi:** Chodząca legenda. Organizm jest obciążony tak potężnie, że krwawe łzy, niekontrolowane drgawki dłoni czy żarły, bolesny kaszel stają się na porządku dziennym. Pod skórą w momentach stresu widać świecące, nienaturalnie przeciążone pajęczyny Zerum.
- **Trzy aktywne Przysięgi:** Agonalny cud. Relikt władzy. Ciało rwie się do strzępów, zmysły gasną, a ból jest tak potężny, że Sama Obecność takiej istoty wywołuje u otoczenia instynktowną grozę. Tacy wojownicy giną o wiele częściej z powodu spalenia własnej fizjologii niż od ciosu przeciwnika.

Przysięga nigdy nie jest magicznym boostem bez kosztów.
Przysięga to dobrowolna **amputacja w zamian za ostrze**. I ciało doskonale o tym wie.
...
| :--- | :--- |
| **Wielokrotność i Koszt Vow** | Splot pozwala na kolejne przesterowania, ale każde nadpisanie drastycznie niszczy biologię, tworząc z użytkownika żywego męczennika ambicji. |
| **Jedna Symbioza na osobę** | Splot utrzymuje połączenie tylko z jednym partnerem. Druga symbiotyczna więź rozerwie użytkownika. |
| **Brak cofania Przysiąg za darmo** | Jedynie elitarni alchemicy mogą cofnąć Vow w zamian za Max HP (starość) – organizm zachowuje trwałą Bliznę. |
...
| **Brak farmy** | Mechaniki to nie zabawki do grindowania. Skok do potęgi obarczony jest drastyczną stawką fizyczną i brakiem bezpiecznych powrotów. |
