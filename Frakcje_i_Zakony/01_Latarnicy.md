...
W systemie Bram Latarnicy odpowiadają za twardy perymetr: kwarantannę wejść, kontrolę dokumentów ekspedycji i niedopuszczanie słabych lub niekompletnych składów do wysokich Tierów ocenionych przez Kartografów. Nie klasyfikują sami Tieru, ale egzekwują jego rygor w praktyce.

Latarnicy nie prowadzą dalekiego zwiadu ani głębokich rajdów wewnątrz instancji wysokiego Tieru. Ich zakres kończy się na strefie bastionowej, perymetrze wejścia i procedurach bezpieczeństwa; operacje głębokie realizują wyspecjalizowane gildie ekspedycyjne.
