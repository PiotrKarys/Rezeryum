...
Każdy Splot ma dominującą Naturę — fundamentalny „smak" energii:

| Natura | Esencja |
|---|---|
| 🔥 **Żar** | Ogień, eksplozje, przepalanie |
| 🌊 **Przepływ** | Woda, krew, adaptacja |
| 🌑 **Cień** | Ciemność, iluzje, kłamstwo |
| ⚙️ **Rdza** | Metal, kość, kruszenie |
...
## Jak działa system mocy?

### Przebudzenie

Większość istot żyje i umiera, nigdy nie aktywując pełni swojego Zerum. **Przebudzenie** to gwałtowny zapłon — wywołany bliską śmiercią, kontaktem z głęboką Komnatą, dotknięciem reliktu lub uświadomieniem sobie własnego Prawdziwego Imienia.

### 5 Progów Mocy

Każdy Przebudzony rozwija się przez Progi:

1. **Iskra** — zmysły się wyostrzają, moce są odruchowe i niedokładne
...
**🐺 Bestyjni** — Ghorran · Kalitropi

**🌑 Głębinowi** — Thrakkor · Voryth · Prosterzy · Myrrhan · Velmari · Orvhan

**🏗️ Cywilizowani** — Raashari · Nythrai · Tharumi
...
| **Prawdziwe Imię** | Fundamentalny kod duszy, wyznaczający potencjał i ścieżki ewolucji |
| **Nadanie Imienia** | Akt krystalizacji Prawdziwego Imienia przez potężniejszą istotę |
| **Głosy Pierwszych** | Pierwotne słowa-wzorce Wysokich, zmieniające prawa rzeczywistości |
| **Więź** | Kontrakt dusz — dwa Sploty się przeplatają, dzieląc moc, rany i emocje |
| **Cień** | Uosobienie tłumionych emocji i traum, konfrontowane na każdym Progu |
...
| **Rodowe Sploty** | Elitarne linie krwi z dziedzicznymi mutacjami Zerum (klany) |
| **Żywe Runy** | Aktywne magiczne zapisy, mogą wrastać w ciała i przedmioty |
| **Archaion** | Gigantyczna bestia, z którą można zawrzeć Więź |
